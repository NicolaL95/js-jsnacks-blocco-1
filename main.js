...
while (cont == true) {
    ...
    if (es_sel == 1) {
        ...
        chk_cont = prompt("Premi un qualsiasi tasto per continuare, n per chiudere il processo")
        if (chk_cont.toLowerCase() == "n") {
            cont = false;
        }
    }
    ...
    if (es_sel == 3) {
        ...
        for (let index = 0; index <= 9; index++) {
            ...
            while (isNaN(element)) {
                element = parseInt(prompt(`Inserito valore non numerio: inserisci il ${index + 1}° numero`));
            }
            sum += element;
        }
        window.alert(`la somma dei numeri inseriti è ${sum}`)
        chk_cont = prompt("Premi un qualsiasi tasto per continuare, n per chiudere il processo")
        if (chk_cont.toLowerCase() == "n") {
            cont = false;
        }
    ...
    if (es_sel == 4) {
        ...
        for (let index = 0; index <= invited_list.length; index++) {
            if (user_invited.toLowerCase() == invited_list[index].toLowerCase()) {
